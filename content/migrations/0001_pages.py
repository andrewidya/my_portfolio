...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'content_post', (
            ...
            ('permalink', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('pub_status', self.gf('django.db.models.fields.BooleanField')()),
        ...
        m2m_table_name = db.shorten_name(u'content_post_tag')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'content_post_tag'))
    ...
    models = {
        ...
        u'content.post': {
            ...
            'permalink': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {}),
            'pub_status': ('django.db.models.fields.BooleanField', [], {}),
            'tag': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['content.Tag']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        u'pages.page': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'childern'", 'null': 'True', 'to': u"orm['pages.Page']"}),
            'permalink': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
